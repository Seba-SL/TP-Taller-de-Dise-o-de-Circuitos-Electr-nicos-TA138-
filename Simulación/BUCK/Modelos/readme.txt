##########################################################################################
## Simulation model of IR2111 Level 1 for SIMetrix version 8.3g or higher
##########################################################################################
...
VER    | BY                       | DATE          | OBS                         
--------------------------------------------------------------------------------
01.00  | AO                       | 2020-06-23    | created    (*1)
--------------------------------------------------------------------------------
01.01  | GI                       | 2020-12-03    | model update
--------------------------------------------------------------------------------
...
The delivery package contains the following:
	...
	\Model\IR2111.lib                         : model lib file
	\Model\IR2111.sxslb                       : schematic symbol for the lib

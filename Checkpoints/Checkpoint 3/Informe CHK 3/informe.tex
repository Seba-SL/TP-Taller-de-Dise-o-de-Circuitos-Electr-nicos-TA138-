...
\end{table}
	...
	\paragraph{Compensación del lazo limitador de corriente}
	\paragraph{Capacitor de suavizado de entrada}
	\paragraph{Ángulo de curva de corte del regulador \textit{Foldback}}
	\paragraph{Rango de regulación}

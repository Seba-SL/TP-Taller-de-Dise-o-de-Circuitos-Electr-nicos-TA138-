...
\begin{document}
	...
	Tomando el diseño del circuito impreso presentado en el \textit{checkpoint 2} y  el cual se puede apreciar en el apéndice \ref{sec:apendice_PCB}, se da paso a el proceso de fabricación del prototipo del PCB.
	...
	Luego, se aplicó la serigrafía superior utilizando el mismo método (véase Figura~\ref{fig:placamontada1}). A continuación, se realizaron las perforaciones correspondientes, se limpió la placa con alcohol isopropílico y se procedió al ensamblado del circuito mediante la colocación de los componentes.

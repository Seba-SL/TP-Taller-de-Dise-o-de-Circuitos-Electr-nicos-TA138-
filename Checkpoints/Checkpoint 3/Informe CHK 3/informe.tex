...
\begin{document}
	...
	Luego, se aplicó la serigrafía superior utilizando el mismo método (véase Figura~\ref{fig:pistasplanchadas}). A continuación, se realizaron las perforaciones correspondientes, se limpió la placa con alcohol isopropílico y se procedió al ensamblado del circuito mediante la colocación de los componentes.
	
	
	%Colocar imagen final con la PCB montada

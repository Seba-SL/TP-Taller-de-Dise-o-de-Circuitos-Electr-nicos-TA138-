...
\begin{document}
	...
	Tomando dos puntos en cada curva correspondientes a la resistencia de $1 k\Omega$  y de $47 \Omega$ y utilizando la expresión \ref{eq:rt_general} se llega a el valor de resistencia de salida de $0,1 \Omega$.

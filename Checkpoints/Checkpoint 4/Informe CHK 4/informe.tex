...
\end{tikzpicture}
	...
	Teniendo en cuenta que el transistor permite replicar la señal de control en el nodo que interconecta los transistores y el inductor, pero con una tensión cercana a la tensión de alimentación. Tal como se ve en la figura \ref{fig:vcontrol}.

	
	De esta relación estimando las tensiones de saturación y de caida de tensión en directa del diodo utilizado, se puede dar con una primer aproximación de D.

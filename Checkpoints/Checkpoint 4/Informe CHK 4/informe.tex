...
\end{tikzpicture}
	...
	Con los valores hallados en la tabla \ref{tab:criticos_mcc} se obtienen los limites para que el circuito trabaje en modo conducción continua, pero no serán los valores óptimos para regular la tensión, para asegurar que el riple sea
	...
	\begin{table}[H]
		...
		\begin{tabular}{|c|c|c|c|}
			...
			Inductor de salida & \(L\) &  &  \\
			\hline
			
			Capacitor de salida & \(C\) &  &  \\
			\hline
			
			Capacitor de entrada & \(C_{in}\) &  &  \\
			\hline
			...
			Corriente máxima de salida & \(I_o\) &  &  \\
			\hline
